# Generated by Django 2.0.5 on 2018-08-24 12:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text='As registered', max_length=30)),
                ('last_name', models.CharField(help_text='As registered', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verdict', models.CharField(choices=[('Candidate', 'Candidate'), ('Member', 'Member'), ('Reserve', 'Reserve'), ('Contact', 'Contact List'), ('Rejected', 'Rejected'), ('Other', 'Other')], default='Candidate', help_text='Outcome as a result of the audition', max_length=30)),
                ('notes', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('season', models.CharField(default='2018/19', help_text='Season of competition', max_length=10)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('season', models.CharField(blank=True, max_length=10, null=True)),
                ('notes', models.TextField(blank=True, help_text='Audition availability and other notes', null=True)),
            ],
            options={
                'ordering': ['created'],
            },
        ...
        migrations.AddField(
            model_name='concert',
            name='players',
            field=models.ManyToManyField(related_name='players', to='ulsosite.Musician'),
        ),
        migrations.AddField(
