# Generated by Django 2.0.5 on 2018-07-20 19:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(help_text='First name and last name as registered', max_length=20)),
                ('dep_first_name', models.CharField(help_text="Dep's first name", max_length=20)),
                ('dep_last_name', models.CharField(help_text="Dep's last name", max_length=20)),
                ('reasons', models.CharField(help_text='Reasons for absence', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='AccordionCard',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('date', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ulsosite.AuditionDate')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accordion_card', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ulsosite.AccordionCard')),
            ],
        ),
        migrations.CreateModel(
            name='Musician',
        ...
        migrations.AddField(
            model_name='image',
            name='section',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ulsosite.Section'),
        ),
        migrations.AddField(
            model_name='concert',
            name='conductor',
        ...
        migrations.AddField(
            ...
            name='page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ulsosite.Page'),
        ),
        migrations.AddField(
            model_name='absence',
            name='musician',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ulsosite.Musician'),
        ),
        migrations.AddField(
            model_name='absence',
            name='rehearsal',
