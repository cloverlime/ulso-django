# Generated by Django 2.0.5 on 2018-08-02 14:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dep_first_name', models.CharField(blank=True, help_text="Dep's first name", max_length=20, null=True)),
                ('dep_last_name', models.CharField(blank=True, help_text="Dep's last name", max_length=20, null=True)),
                ('reasons', models.CharField(blank=True, help_text='Reasons for absence', max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Account',
